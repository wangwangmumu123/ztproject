...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    const init = async (id, type) => {
      ...
      if (type === "dishId") {
        res = await api_product.getDishByIdAPI(id);
        dish.value = res.data;
      } else {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-9cb6f745"], ["__file", "D:/code/git/supermarket-manager/hanye-take-out-uniapp/src/pages/detail/detail.vue"]]);
