  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        n: common_vendor.t(order.amount),
        o: common_vendor.t(order.number),
        p: common_vendor.t(order.orderTime),
        q: common_vendor.t(order.address),
        r: common_vendor.sr(childComp, "2d945b00-1", {
          "k": "childComp"
        })
      });
    };
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-2d945b00"], ["__file", "D:/code/git/supermarket-manager/hanye-take-out-uniapp/src/pages/orderDetail/orderDetail.vue"]]);
