...
<template>
  <el-card>
    <div class="horizontal">
      <el-input size="large" class="input" v-model="pageData.name" placeholder="请输入想查询的员工职位" />
    ...
    <el-table :data="employeeList" stripe>
      ...
      <el-table-column prop="account" label="姓名" align="center" />
  ...
  <el-button 
    ...
    type="primary" 
    :disabled="userInfoStore.userInfo?.account !== '管理员' 
