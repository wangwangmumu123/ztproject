    ...
    <div class="container" :class="{ hContainer: tableData.length }">
      ...
      <el-table v-if="tableData.length" :data="tableData" stripe class="tableBox">
        ...
        <el-table-column v-if="[0, 2, 5].includes(orderStatus)" key="amount" prop="amount" label="实收金额" align="center">
          <template v-slot="{ row }">
            <span>{{ (row.amount.toFixed(2) * 100) / 100 }}元</span>
          </template>
        </el-table-column>
      ...
      <el-scrollbar style="height: 100%">
        ...
        <div class="order-middle">
          <div class="user-info">
            ...
            <div v-if="dialogOrderStatus === 6" class="user-remark orderCancel">
              <div>取消原因</div>
              <span>{{
          ...
          <div class="dish-info">
            ...
            <div class="dish-all-amount">
              <label>商品小计：</label>
              <span>￥{{ (diaForm && typeof diaForm.amount === 'number' && typeof
          ...
          <div class="amount-info">
            ...
            <div class="amount-list">
              <div class="dish-amount">
                <span class="amount-name">总计：</span>
                <span class="amount-price">￥{{ (diaForm && typeof diaForm.amount === 'number') ? (diaForm.amount).toFixed(2) : 0 }}
                </span>
              </div>
