<template>
  <div class="dashboard-container home">
    ...
    <!-- end -->
      ...
      <!-- 菜品总览 -->
    <CuisineStatistics 
      :productList="dishesData.productList" 
...
import { getBusinessDataAPI, getOrderDataAPI, getOverviewDishesAPI,  } from '@/api/dashboard'
...
// 父组件的 setup 部分
const dishesData = ref<any>({ productList: [] })
...
const handleUpdateProduct = async () => {
  try {
    ...
    if (res.data.code === 0) {
      ...
      dishesData.value.productList = res.data.data
    } else {
      console.error(res.data.msg)
    }
  } catch (err) {
